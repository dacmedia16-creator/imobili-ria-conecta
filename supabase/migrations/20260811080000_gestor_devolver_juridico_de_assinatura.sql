-- Na etapa "Aguardando assinatura" não existia nenhum caminho de volta — só subir/marcar o
-- contrato assinado, arquivar ou cancelar. Se o contrato precisar de ajuste nessa altura (cláusula
-- errada, documento trocado), o gestor não tinha como devolver ao jurídico pra corrigir, igual já
-- podia fazer em contrato_conferencia_gestor. Libera essa mesma transição a partir de
