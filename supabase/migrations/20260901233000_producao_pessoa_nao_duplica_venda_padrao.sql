-- Vendedores detalhados em occurrence_commissions são usados para ratear somente lançamentos.
-- Em venda padrão, ligar essas linhas à operação multiplica a mesma venda quando existem dois
-- registros de vendedor. Restringir o JOIN preserva uma linha por venda padrão.
