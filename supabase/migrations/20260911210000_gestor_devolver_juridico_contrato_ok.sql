-- Permite que o gestor devolva ao Jurídico uma venda em contrato_ok_corretor
-- quando o Jurídico bloqueou a assinatura por pendência documental.
-- O retorno exige motivo pela interface e não libera assinatura automaticamente.
