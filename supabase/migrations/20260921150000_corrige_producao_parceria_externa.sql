-- Corrige o contrato da Produção por pessoa com as flags de parceria externa.
-- Sem estas chaves, o frontend interpreta uma ponta externa como se estivesse
-- sem corretor e divide indevidamente o VGV/comissão entre duas pontas.
