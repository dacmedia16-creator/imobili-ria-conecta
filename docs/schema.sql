...
CREATE TABLE IF NOT EXISTS public.sales (
  ...
  previsao_recebimento2_valor numeric(14,2),
  previsao_recebimento2_data date,
  previsao_recebimento2_forma text,
  previsao_recebimento3_valor numeric(14,2),
  previsao_recebimento3_data date,
  previsao_recebimento3_forma text,
  ...
  parceria_tipo text,
  parceria_nome text,
  parceria_cpf_cnpj text,
  parceria_percentual numeric(6,3),
  parceria_valor numeric(14,2),
  parceria_banco text,
...
CREATE TABLE IF NOT EXISTS public.sale_payment (
  ...
  parcela2_data text,
  pagamento_final_valor numeric(14,2),
  pagamento_final_data text,
  ...
  oba_credito boolean DEFAULT false,
  tipo_pagamento text,
  consorcio_nome text,
...
CREATE TABLE IF NOT EXISTS public.occurrence_partners (
  ...
  pix text,
  tipo text,
  from_sale boolean NOT NULL DEFAULT false,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
