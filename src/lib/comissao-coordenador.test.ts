...
const LINHAS: LinhaComissaoCoordenador[] = [
  // Lançamento
  {
    occurrence_id: "occ-lanc-1",
    modalidade: "lancamento",
    papel: "corretor_vendedor",
    user_id: "wilson",
    nome: "Wilson Grecchi Junior",
    valor: 5613.12,
  ...
  {
    occurrence_id: "occ-lanc-4",
    modalidade: "lancamento",
    papel: "coordenador_lancamento",
    user_id: "aline",
  ...
  // Padrão
  {
    occurrence_id: "occ-pad-1",
    modalidade: "padrao",
    papel: "corretor_captador",
    user_id: "carlos",
    nome: "Carlos Eduardo Carneiro",
    valor: 1080.0,
    sem_cadastro_confirmado: false,
  },
  {
  ...
  {
    occurrence_id: "occ-pad-2",
    modalidade: "padrao",
    papel: "corretor_captador",
    user_id: "wanderley",
    nome: "Wanderley Hiro Sato",
    valor: 4387.5,
    sem_cadastro_confirmado: false,
  },
  {
  ...
  },
  {
    ...
    papel: "lider_captador",
    user_id: "salvador",
    nome: "Salvador Ramalho",
    valor: 2437.5,
    sem_cadastro_confirmado: false,
  },
  {
    occurrence_id: "occ-pad-3",
    modalidade: "padrao",
    papel: "corretor_captador",
    user_id: "ailton",
    nome: "Ailton Alexandria",
    valor: 4252.5,
    sem_cadastro_confirmado: false,
  },
  {
  ...
  {
    occurrence_id: "occ-pad-4",
    modalidade: "padrao",
    papel: "corretor_captador",
    user_id: "wellington",
    nome: "Wellington de Oliveira",
    valor: 2700.0,
    sem_cadastro_confirmado: false,
  },
  {
