  ...
  const onCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        ...
        toast.error(errorMessage(err, "Falha ao criar venda"));
      }
    } finally {
      setLoading(false);
    }
    ...
    return (
      <Card className="mx-auto max-w-2xl">
        <CardContent className="py-8 text-center text-sm text-muted-foreground">
          Somente corretores, gestores e Team Leaders podem criar uma venda comum. Para registrar um
          Lançamento, use a opção específica disponível para os perfis autorizados.
        </CardContent>
      </Card>
    );
  }
    ...
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Venda comum para corretor, gestor ou Team Leader. Comece informando o imóvel; os demais
          dados poderão ser preenchidos depois.
        </p>
      </div>
      <Card>
        <CardHeader>
          <CardTitle>Identificação do imóvel</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={onCreate} className="space-y-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v) => setTipoPessoaVendedor(v as "fisica" | "juridica")}
              >
                <SelectTrigger id="tipo-pessoa-vendedor">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v) => setTipoPessoaComprador(v as "fisica" | "juridica")}
              >
                <SelectTrigger id="tipo-pessoa-comprador">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="fisica">Pessoa física</SelectItem>
